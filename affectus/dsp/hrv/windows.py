...
from affectus.config import ANALYSIS_WINDOW_SECONDS, IBI_BUFFER_RETENTION_MS
...
from affectus.io.messages import IbiBatchMessage, InterbeatIntervalEntry
...
class RollingSensorBuffer:
    ...
    latest batch, so a windowed motion statistic had no history to draw on; this
    buffer provides the per-window median."""

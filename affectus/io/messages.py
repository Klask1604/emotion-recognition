...
class AcquisitionBatchMessage:
    ...
    def timestamp_ms(self) -> int:
        """Canonical timestamp alias. The batch IS the sensor record the pipeline
        reads, so consumers refer to `.timestamp_ms` like any other message."""
        return self.timestamp_anchor_ms

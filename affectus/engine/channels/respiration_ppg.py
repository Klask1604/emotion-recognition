...
from affectus.engine.channels.respiration_rsa import RespirationEstimate
...
def _per_beat_amplitudes(
    ...
    nyq = fs / 2.0
    from affectus.config import PPG_BAND_HI_HZ, PPG_BAND_LO_HZ, PPG_MIN_BEAT_DISTANCE_S

...
class ResearchEngines:
    ...
    def __init__(self) -> None:
        ...
        if toggles.ENABLE_POLARITY:
            from affectus.research.polarity.engine import PolarityEngine
        ...
        if toggles.ENABLE_WESAD:
            from affectus.research.wesad_stress_engine import WesadEngine
    ...
    def run(self, *, batch, result, baseline) -> ResearchOutputs:
        ...
        if self._wesad is not None and primary is not None:
            out["wesad"] = self._wesad.predict(primary)
